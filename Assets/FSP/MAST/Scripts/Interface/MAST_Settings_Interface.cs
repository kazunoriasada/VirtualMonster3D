...
public class MAST_Settings_Interface : EditorWindow
{
#if (UNITY_EDITOR)
...
// ---------------------------------------------------------------------------
    private void PlacementGUI()
    {
        ...
        if (placementRandomizerFoldout) 
        {
            ...
            EditorGUILayout.LabelField("Randomize Rotation", EditorStyles.boldLabel);
            
            MAST_Settings.placement.randomizer.rotateX =
                GUILayout.Toggle(MAST_Settings.placement.randomizer.rotateX, "X");
            MAST_Settings.placement.randomizer.rotateY =
                GUILayout.Toggle(MAST_Settings.placement.randomizer.rotateY, "Y");
            MAST_Settings.placement.randomizer.rotateZ =
                GUILayout.Toggle(MAST_Settings.placement.randomizer.rotateZ, "Z");
...
// ---------------------------------------------------------------------------
    private void GUIGUI()
    {
        ...
        MAST_Settings.gui.toolbar.position =
            ...
            "Toolbar Position", MAST_Settings.gui.toolbar.position);
        ...
        if (guiGridFoldout)
        {
            ...
            MAST_Settings.gui.grid.unitSize =
                EditorGUILayout.FloatField(new GUIContent(
                "Unit Size", "Size of an individual grid square"),
                MAST_Settings.gui.grid.unitSize);
