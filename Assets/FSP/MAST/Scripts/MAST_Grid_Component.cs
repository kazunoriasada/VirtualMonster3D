...
public class MAST_Grid_Component : MonoBehaviour
{
	...
	void OnDrawGizmos ()
	{
        ...
        for (int x = xMin; x < xMax+1; x++)
		{
			...
			Vector3 pos1 = new Vector3(x, 0, zMin) * gridUnitSize;
			Vector3 pos2 = new Vector3(x, 0, zMax) * gridUnitSize;
		...
		for (int z = zMin; z < zMax+1; z++)
		{
			...
			Vector3 pos1 = new Vector3(xMin, 0, z) * gridUnitSize;
            Vector3 pos2 = new Vector3(xMax, 0, z) * gridUnitSize;
    ...
    public void UpdateSettings()
    {
        ...
        gridUnitSize = Mathf.Max(0, Mathf.Abs(MAST_Settings.gui.grid.unitSize));
        ...
        transform.localScale = new Vector3(
            gridUnitSize * xMax * 2f / 10f,
            1f,
            gridUnitSize * zMax * 2f / 10f);
    }
