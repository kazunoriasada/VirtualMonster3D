...
public static class MAST_Placement_Place
{
    ...
    public static GameObject PlacePrefabInScene()
    {
            ...
            MAST_Placement_Visualizer.GetGameObject() != null)
        {
            ...
            GameObject newPrefab = GameObject.Instantiate(MAST_Settings.gui.palette.prefab[MAST_Settings.gui.palette.selectedItemIndex]);
            
            // Correct GameObject transform and name
            ...
            newPrefab.name = MAST_Settings.gui.palette.prefab[MAST_Settings.gui.palette.selectedItemIndex].name;
