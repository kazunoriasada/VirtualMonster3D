...
public class MAST_PrepModels
{
    ...
    private void GetModelsInSelectedFolder()
    {
        pathSelected = MAST_Asset_Loader.GetPathOfSelectedFolder();
    ...
    public void AddMASTScriptsToPrefabsInFolder()
    {
        ...
        foreach (GameObject prefab
            in MAST_Asset_Loader.GetPrefabsInSelectedFolder(true))
        {
